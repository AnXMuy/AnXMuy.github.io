...
export const metadata: Metadata = { title: "Posts & Notes" };

export default function NotesPage() {
  return (
    <main className="subpage-main">
      <div className="content-container">
        <PageIntro eyebrow="Working notes" title="Posts & Notes" description="Technical writing, open resources, and projects built along the way." />
          ...
          <Reveal>
            <article className="note-row">
              ...
              <div>
                ...
                <h2><Link href="/notes/tcs-review/">TCS — Review & Cheatlist</Link></h2>
                <span>Open-source Theory of Computation exam review notes and a compact cheat list.</span>
                <div className="note-links">
                  <Link href="/notes/tcs-review/">Read notes <ArrowUpRight aria-hidden="true" /></Link>
